// @observablehq/runtime v4.18.0 Copyright 2021 Observable, Inc.
function e(e, t, n) {
  n = n || {};
...
class le {
  constructor(e) {
    ...
    (this._node = e), e.classList.add(`observablehq${index++}`);
  }
  pending() {
    const { _node: e } = this;
...
Ie.amd = {};
const Be = ze("d3", "7.1.1", "dist/d3.min.js"),
  He = ze("@observablehq/inputs", "0.10.3", "dist/inputs.min.js"),
  We = ze("@observablehq/plot", "0.2.9", "dist/plot.umd.min.js"),
